...
# March 11th, 2024 - Stripe intergration and RBAC Update

Attaching stripe based payment method and RBAC. Will probably use a similar method I did for Fleamarket of Louisiana where I hardcoded it instead of FB's method. Considering I'm the only admin it seems appropriate (plus effecient). I'll need a  